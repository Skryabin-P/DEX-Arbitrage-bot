...
if __name__ == "__main__":
    ...
    sushi3 = SushiSwapV3(net, subnet, infura_api_key, 500, ganache)
    sushi3.pair_list = pairs
    sushi2 = SushiSwapV2(net, subnet, infura_api_key, ganache)
    sushi2.pair_list = pairs
    pancakeswap_v2 = PancakeSwapV2(net, subnet, infura_api_key, ganache)
    pancakeswap_v2.pair_list = pairs
    pancakeswap_v3 = PancakeSwapV3(net, subnet, infura_api_key, 500, ganache)
